# AI-Travel-Planner-
🚀 Excited to share my latest project: AI-Powered Travel Planner built using Gemini 2.5 Flash and advanced Natural Language Processing (NLP) concepts!
import csv
...
genai.configure(api_key="AIzaSyAmmH7MMoKhD_G6D5SQJL3pIxYd3jjYwCc")
